public class BinarySearchTree<E extends Comparable<E>> {
	...
	private Node findNode(Node n, E val) 
	{
	    if (val.compareTo(n.value) == 0) 
	        ...
	        return n.leftChild == null ? null : findNode(n.leftChild, val);
        else 
	        return n.rightChild == null ? null : findNode(n.rightChild, val);
    }
	...
	{
	    int left = n.leftChild == null ? 0 : 1 + height(n.leftChild);
	    int right = n.rightChild == null ? 0 : 1 + height(n.rightChild);
	...
	protected boolean isBalanced(Node n) 
	{
		...
		if (!contains(n.value)) 
			return false;
		int left = n.leftChild == null ? -1 : height(n.leftChild);
		int right = n.rightChild == null ? -1 : height(n.rightChild);
	...
	public boolean allBalanced(Node n) 
	{
